...
const bootLines = [
    ...
    { text: "Completed. Ready to explore.", delay: 400 },
];
...
export default function HeroSection({ onNavigate, onInView, onLucasAppear }: HeroSectionProps) {
                    ...
                    <>
                        ...
                        >
                                ...
                                <motion.p
                                    ...
                                    className="mt-4 font-mono text-xs text-nx-text-muted"
                                >
